    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/60 p-10 border border-slate-100">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-extrabold text-slate-900 tracking-tight mb-2">Post a New Job</h2>
                <p class="text-slate-500 font-medium">Reach the world's most innovative talent.</p>
            </div>
            
            <form method="POST" action="/listings" class="space-y-8">
